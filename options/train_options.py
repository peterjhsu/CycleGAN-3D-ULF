...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--split_train', action='store_true', help='50/50 split train [T1w] vs [T1w, T2w] outputs')
        ...
        parser.add_argument('--beta1', type=float, default=0.9, help='momentum term of adamW')
        parser.add_argument('--lr', type=float, default=0.0001, help='initial learning rate for adamW')
        ...
        parser.add_argument('--no_shuffle', action='store_false', help='use for paired input and output data')
        self.isTrain = True
        return parser
