...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--label_path', type=str, default='./Data_folder/labels/', help='Labels images path')
        parser.add_argument('--data_nums', nargs='+', default=[1, 2], type=int, help='folder numbers reflecting input channels (images)')
        parser.add_argument('--label_nums', nargs='+', default=[1, 2], type=int, help='folder numbers reflecting input channels (labels)')

        parser.add_argument('--pretrain', type=str, default='None', help='pretrain weights folder')
        parser.add_argument('--pretrain_epoch', type=str, default='latest', help='epoch to load from pretrained weights')
        parser.add_argument('--batch_size', type=int, default=2, help='input batch size')
        parser.add_argument('--patch_size', type=int, nargs=3, default=[128, 128, 128], help='Size of the patches extracted from the image')
        parser.add_argument('--pad_size', type=int, nargs=3, default=[256, 256, 256], help='Padding of input images')
        ...
        parser.add_argument('--img_norm', type=str, default='zscore', help='network initialization [zscore|zeroone]')
